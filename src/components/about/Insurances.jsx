...
export function Insurances({ showConsultationCTA = true } = {}) {
    return (
                        ...
                        <div className="mt-8 flex flex-col sm:flex-row gap-4">
                            ...
                            <Sheet>
                                <SheetTrigger asChild>
                                    <Button variant="ghost" className="inline-flex items-center text-[#2D6762] text-lg hover:text-[#6D519D] transition-colors duration-300 group">
