...
import { VerifyInsuranceForm } from "@/components/forms/VerifyInsuranceForm";
...
const processSteps = [
  {
    ...
    description: "Complete the form with your insurance details",
  },
  {
    step: 2,
    title: "We Verify Benefits",
    description: "Our team contacts your carrier within 2-3 business days",
  },
  {
    step: 3,
  ...
  },
  {
    ...
    description: "Book your appointment with full clarity on costs",
  },
]
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        ...
        >
          ...
          <p className="mt-4 text-lg text-muted-foreground text-pretty leading-relaxed">
            Know your coverage before your first visit. Submit your insurance information below and our team will verify your benefits,
            so you can focus on your care without financial surprises.
          </p>
        </motion.div>
...
export const VerifyInsurancePage = {
  HeroSection,
  MainSection,
  FAQSection,
};